...
from core.memory import MemoryManager, SessionMemory, DualLayerMemoryManager
from core.memory_extractor import MemoryExtractor
from core.memory_distiller import MemoryDistiller
from core.prompt_context import PromptContext
from core.prompting import PromptBuilder
from core.reasoning import AskUserNeeded, ReasoningEngine, ConfirmationNeeded
from core.runtime_facts import answer_date_or_time_query, current_datetime_text
from core.session import SessionManager
from core.task_state import TaskStatus, TaskStateStore
...
from core.emotion.schema import EmotionResult, EMOTION_STRATEGIES
...
class Agent:
    ...
    async def chat(
        ...
        *,
        ...
        logger.info("Agent chat start: session_id=%s user_id=%s message=%s", session_id, user_id or session_id, message[:100])
